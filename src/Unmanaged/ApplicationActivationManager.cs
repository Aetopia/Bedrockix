...
{
    [PreserveSig]
    int ActivateApplication(string appUserModelId, nint arguments, int options, out int processId);
...
sealed class ApplicationActivationManager : IApplicationActivationManager
{
    ...
    public extern int ActivateApplication(string appUserModelId, nint arguments, int options, out int processId);
